    ...
    <main className="arche-page">
      <style>{`
        ...
        :root {
          ...
          --bronze-soft: rgba(210, 172, 116, 0.42);
        ...
        .page-shell {
          ...
          padding: 0 1.25rem 0;
          background:
            radial-gradient(circle at 50% 5%, rgba(96, 157, 157, 0.34), transparent 25rem),
            radial-gradient(circle at 50% 38%, rgba(61, 115, 112, 0.18), transparent 42rem),
            linear-gradient(180deg, #143f42 0%, #103337 22%, #0b2528 48%, #061513 74%, #020504 100%);
        }
        ...
        .page-shell::before {
          ...
          pointer-events: none;
          background-image:
            linear-gradient(rgba(225, 188, 130, 0.03) 1px, transparent 1px),
            linear-gradient(90deg, rgba(225, 188, 130, 0.024) 1px, transparent 1px);
          background-size: 72px 72px;
          mask-image: linear-gradient(180deg, rgba(0,0,0,0.84), rgba(0,0,0,0.31) 56%, transparent 93%);
        }
        ...
        .logo-header {
          ...
          align-items: center;
          background: linear-gradient(180deg, #010303 0%, var(--logo-black) 58%, #030808 100%);
          border-bottom: 1px solid rgba(210, 172, 116, 0.08);
          box-shadow: 0 18px 46px rgba(0, 0, 0, 0.28), 0 1px 0 rgba(255, 255, 255, 0.02) inset;
        }
        ...
        .company-logo {
          ...
          height: auto;
          opacity: 0.96;
          filter: contrast(1.04) saturate(0.94) drop-shadow(0 0 10px rgba(213, 179, 130, 0.1));
        }
        ...
        .arche-title {
          ...
          text-shadow: 0 0 34px rgba(211, 171, 111, 0.16), 0 22px 48px rgba(0,0,0,0.44);
          user-select: none;
        }
        ...
        @media (max-width: 760px) {
          .page-shell { min-height: 285vh; padding-top: 0; }
          .logo-header { padding: 1rem 1rem 0.9rem; }
          .company-logo { width: min(520px, 88vw); }
          .present-line { margin-top: 2rem; margin-bottom: 1rem; letter-spacing: 0.28em; }
          .arche-title { transform: scaleX(1); letter-spacing: 0.032em; font-size: clamp(3.6rem, 17vw, 6.4rem); }
          .bridge-wrap { width: 118vw; margin-top: -1.45rem; }
          .persona-section { top: 36%; width: min(500px, 64vw); }
          .persona-list { margin-top: 2.1rem; gap: 1.15rem; }
          .thesis-section { margin-top: -5rem; padding-bottom: 12rem; }
            ...
            <svg viewBox="0 0 1200 900" className="bridge-svg" role="img" aria-label="ARCHE true arch bridge system">
              <defs>
                ...
                <linearGradient id="pillarFade" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="rgba(210,172,116,0.48)" />
                  <stop offset="66%" stopColor="rgba(210,172,116,0.25)" />
              ...
              <g filter="url(#lineGlow)">
                ...
                <text x="600" y="116" textAnchor="middle" className="systems-type" fontSize="18" fill="rgba(225, 193, 145, 0.88)">
